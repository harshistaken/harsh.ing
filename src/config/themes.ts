...
export const themes: ThemeDefinition[] = [
...

  {
    ...
    light: {
      ...
      "--bg-surface": "#f9f5d7",
      "--text-primary": "#282828",
      "--text-secondary": "#49423e",
      "--text-tertiary": "#5c5046",
      "--text-muted": "#6b5d49",
    ...
    dark: {
      ...
      "--bg-surface": "#504945",
      "--text-primary": "#fbf1c7",
      "--text-secondary": "#dac9a6",
      "--text-tertiary": "#c3b39e",
      "--text-muted": "#aca198",
...

  {
    ...
    light: {
      ...
      "--bg-surface": "#fdf6e3",
      "--text-primary": "#5c6a72",
      "--text-secondary": "#415058",
      "--text-tertiary": "#515f50",
      "--text-muted": "#626b5c",
    ...
    dark: {
      ...
      "--bg-surface": "#475258",
      "--text-primary": "#d3c6aa",
      "--text-secondary": "#d6e3d9",
      "--text-tertiary": "#beccc2",
      "--text-muted": "#aab9b4",
...

  {
    ...
    light: {
      ...
      "--bg-surface": "#f2ecbc",
      "--text-primary": "#43436c",
      "--text-secondary": "#3f3e4e",
      "--text-tertiary": "#4f4e46",
      "--text-muted": "#5d5b4e",
    ...
    dark: {
      ...
      "--bg-surface": "#363646",
      "--text-primary": "#dcd7ba",
      "--text-secondary": "#d0c89b",
      "--text-tertiary": "#b5b4ab",
      "--text-muted": "#a0a0bc",
...

  {
    ...
    dark: {
      ...
      "--bg-surface": "#4c566a",
      "--text-primary": "#eceff4",
      "--text-secondary": "#e2e8f3",
      "--text-tertiary": "#c3d2ed",
      "--text-muted": "#b3bfd6",
...

  {
    ...
    light: {
      ...
      "--bg-surface": "#eff1f5",
      "--text-primary": "#4c4f69",
      "--text-secondary": "#42455c",
      "--text-tertiary": "#515469",
      "--text-muted": "#5d606f",
    ...
    dark: {
      ...
      "--bg-surface": "#313244",
      "--text-primary": "#cdd6f4",
      "--text-secondary": "#dae2ff",
      "--text-tertiary": "#c4cbe7",
      "--text-muted": "#b3b7cf",
...

  {
    ...
    light: {
      ...
      "--bg-surface": "#e9eaf0",
      "--text-primary": "#3760bf",
      "--text-secondary": "#253169",
      "--text-tertiary": "#3c4266",
      "--text-muted": "#4e5059",
    ...
    dark: {
      ...
      "--bg-surface": "#343a52",
      "--text-primary": "#c0caf5",
      "--text-secondary": "#b2bae0",
      "--text-tertiary": "#9ca7d5",
      "--text-muted": "#8e97bb",
