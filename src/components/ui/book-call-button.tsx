...
export function BookCallButton() {
    ...
    return (
        <a
            ...
            className="group relative flex w-full items-center justify-center overflow-hidden border border-accent-primary px-3 py-1.5 font-jetbrains text-[12px] uppercase tracking-wider"
            onPointerEnter={(e) => {
        ...
        >
            ...
            <span className={cn(
                ...
                hovered ? "text-accent-primary" : "text-bg-primary"
            )}>{displayText}</span>
        </a>
    );
}
