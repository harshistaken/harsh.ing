            ...
            <div className="flex min-w-0 flex-1 flex-col justify-center gap-4">
                <p className="font-fragment text-[14px] leading-[1.7] tracking-normal text-text-secondary">
                    ...
                    <span className="inline-flex items-center gap-1">
                        <Image src="/logos/hammurabi.svg" alt="" width={14} height={14} className="inline-block h-3.5 w-3.5" />
                    ...
                    <span className="inline-flex items-center gap-1">
                        <Image src="/logos/upwork.svg" alt="" width={14} height={14} className="inline-block h-3.5 w-3.5" />
